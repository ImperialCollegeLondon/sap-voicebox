...
%
% See also: v_gaussmix, v_gaussmixg, v_gaussmixp, v_randvec

%      Copyright (C) Mike Brookes 2000-2012
%      Version: $Id: v_gaussmixt.m 10865 2018-09-21 17:22:45Z dmb $
%
...
if ~nargout
    if p==1
        ...
        plot(xax,v_gaussmixp(xax(:),m1,v1,w1),'--b');
        hold on
        plot(xax,v_gaussmixp(xax(:),m2,v2,w2),':r');
        plot(xax,v_gaussmixp(xax(:),m,v,w),'-k');
        hold off
