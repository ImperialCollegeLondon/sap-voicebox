...
% e.g. v_txalign([1 11 21 27 31 42 51],[2 12 15 22 25 32 41 52 61],1.1);
...
%
% If no outputs are specified, v_txalign plots a graph showing y-x against mean(x,y)

%      Copyright (C) Mike Brookes 2002
%      Version: $Id: v_txalign.m 10865 2018-09-21 17:22:45Z dmb $
%
