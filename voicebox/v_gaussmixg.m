...
%
% Refs:
%   [1]	M. �. Carreira-Perpi��n. Mode-finding for mixtures of gaussian distributions.
%       IEEE Trans. Pattern Anal and Machine Intell, 22 (11): 1318�1323, 2000. doi: 10.1109/34.888716.
%   [2] M. �. Carreira-Perpi��n and C. K. I. Williams. On the number of modes of a gaussian mixture.
...
%
% See also: v_gaussmix, v_gaussmixd, v_gaussmixp, v_randvec

%      Copyright (C) Mike Brookes 2000-2012
%      Version: $Id: v_gaussmixg.m 10865 2018-09-21 17:22:45Z dmb $
%
    ...
    switch p
        ...
        otherwise
            ...
            for i=1:p
                ...
                [mm,vm,wm]=v_gaussmixd(mg(ix),m,v,w,[],ix);
                ym=v_gaussmixp(xi,mm,vm,wm')+lpm-gaussmixp(mg(i),mm,vm,wm');
                [mp,vp,wp]=v_gaussmixd(pg(1,ix),m,v,w,[],ix);
                yp=v_gaussmixp(xi,mp,vp,wp')+lpp-gaussmixp(pg1(i),mp,vp,wp');
                subplot(nr,nc,i);
