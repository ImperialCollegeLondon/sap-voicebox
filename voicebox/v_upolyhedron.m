function [vlist,edgeq,flist,info]=v_upolyhedron(w,md)
...
% Example slide show:
% for i=1:74, disp(num2str(i)); v_upolyhedron(i); pause(2); end
% for i=5:10, disp(num2str(i)); for j=1:5, v_upolyhedron(i+j/10); pause(2); end, end

%      Copyright (C) Mike Brookes 1997
%      Version: $Id: v_upolyhedron.m 10865 2018-09-21 17:22:45Z dmb $
%
...
while i<=nv  % loop for each vertex
    ...
    k = frot(i);    % v_rotation to use first
    v1 = vlist(i,1:3);    % the centre of v_rotation
