...
%ROTRO2QR converts a 3x3 v_rotation matrix to a real quaternion
% Inputs: 
%
...
% in the comments below, t is the v_rotation angle, a is the v_rotation axis
q=zeros(4,1);
t = 1 + r(1) + r(5) + r(9);     % 2(1+cos(t)) = 4(cos(t/2))^2 = 4 q(1)^2
if t>1                       % for v_rotation angles less than 120 degrees
